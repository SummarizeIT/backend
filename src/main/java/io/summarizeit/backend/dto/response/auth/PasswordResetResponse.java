...
public class PasswordResetResponse extends AbstractBaseResponse {
    @Schema(name = "id", description = "UUID", type = "String", example = "120b2663-412a-4a98-8c7b-19115fd8a0b0")
    private String id;

    @Schema(name = "token", description = "Token", type = "String", example = "KQJGpJ...")
    private String token;

    @Schema(name = "userId", description = "User ID", type = "String")
    private UUID userId;

    @Schema(name = "expirationDate", description = "Expiration date", type = "String", example = "2003-09-15 12:34:46.7")
    private Date expirationDate;

    @Schema(name = "createdAt", description = "Date time field of user creation", type = "LocalDateTime", example = "2002-09-29T22:37:31")
    private LocalDateTime createdAt;

    @Schema(name = "updatedAt", type = "LocalDateTime", description = "Date time field of user update", example = "2002-09-29T22:37:31")
