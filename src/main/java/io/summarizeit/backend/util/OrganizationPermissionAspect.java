...
public class OrganizationPermissionAspect {
    ...
    public class BankAccountAspect {
        ...
        @Before(value = "@annotation(io.summarizeit.backend.util.OrganizationPermission)")
        public void getAccountOperationInfo(JoinPoint joinPoint) {
            ...
            System.out.println("Account operation annotation: " + organizationPermission);
            System.out.println("Account operation value: " + organizationPermission.permissions());
        }
    }
